          ...
          <Col style={{ zIndex: 1 }} md={4}>
            <div id="first">
              <Image
                ...
                fluid
                src="/images/colourtrends-category.jpg"
              />
            </div>
            <br />
            <div id="second">
              <Image fluid src="/images/Styles-category.jpg" />
            </div>
            <br />
            <div id="third">
              <Image fluid src="/images/dshape-category.jpg" />
            </div>
            <br />
            <div id="fourth">
              <Image fluid src="/images/shape-category.jpg" />
            </div>
            <br />
          </Col>
          <Col md={8}>
